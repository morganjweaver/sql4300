...
EvalPlan::EvalPlan(ColumnNames *projection, EvalPlan *relation)
        : type(Project), projection(projection), relation(relation), select_conjunction(nullptr), table(Dummy::one()) {
}

EvalPlan::EvalPlan(ValueDict* conjunction, EvalPlan *relation)
        : type(Select), select_conjunction(conjunction), relation(relation), projection(nullptr), table(Dummy::one()) {
}
